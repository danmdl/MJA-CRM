    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor="apartmentNumber" className="text-sm font-medium">Número de Apartamento</label>
            <Input
              id="apartmentNumber"
          ...
          {/* Cell selector */}
          <div className="space-y-2">
            <label htmlFor="cellId" className="text-sm font-medium">Célula</label>
            <Select
          ...
          {/* Leader selector */}
          <div className="space-y-2">
            <label htmlFor="leaderAssigned" className="text-sm font-medium">Líder Asignado</label>
            <Select
